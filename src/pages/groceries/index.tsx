import { Box, Text, Flex, Heading, Button, Icon, Table, Thead, Tr, Th, HStack, Tooltip, Tbody, Td, useBreakpointValue, Spinner } from "@chakra-ui/react";
                            ...
                            <Tbody>
                                {data.groceries.map(grocery => (
                                    <Tr key={grocery.id}>
                                        <Td>
                                            <Box>
                                                <Text fontWeight="bold" textTransform="capitalize">{grocery.name}</Text>
                                            </Box>
                                        </Td>
                                        <Td>
